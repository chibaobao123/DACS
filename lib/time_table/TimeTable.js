    ...
    */
    setWorkTimeColumn(){
        ...
        tbody.each((i,elem)=>{
			...
			$(elem).append(`<td class="TimeTable__worktime js-workTime"><button class='btnDatSan btn btn-success p-1 my-1' style="font-size:15px;"><i class="far fa-edit"></i></button></td>`);
        });
    }
    /**
    ...
    */
    initialDraw(){
        ...
        for(;;){
			...
			let shape = this.drawLine(index,sTime,eTime,4,over);
