...
function veTableDatSan(data) {
	...
	for (var i = 0; i < data.length; i++) {
		...
		if (thanh_toan == "0") {
			html += "<td><center><button class='btnThanhToan' datsan_id='" + data[i].datsan_id + "'>Thanh toán</button></center></td>";
		} else {
			html += "<td><center><button disabled class='btnThanhToan' datsan_id='" + data[i].datsan_id + "'>Thanh toán</button></center></td>";
		}
		
		html += "<td><center><button class='btnXoaDatSan' datsan_id='" + data[i].datsan_id + "'>Xóa</button></center></td>";
		html += "</tr>";
	}
